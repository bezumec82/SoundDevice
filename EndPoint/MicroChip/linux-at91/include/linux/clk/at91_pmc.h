...
#define     AT91_PMC_PCR_GCKCSS(val)    ((val) << AT91_PMC_PCR_GCKCSS_OFFSET)  /* GCK Clock Source Selection */
...
#define     AT91_PMC_AUDIO_PLL_ND(val)                  ((val) << AT91_PMC_AUDIO_PLL_ND_OFFSET)

#define     AT91_PMC_AUDIO_PLL_QDPMC_OFFSET             16
#define     AT91_PMC_AUDIO_PLL_QDPMC_MASK               (0x7f << AT91_PMC_AUDIO_PLL_QDPMC_OFFSET)
#define     AT91_PMC_AUDIO_PLL_QDPMC(val)               ((val) << AT91_PMC_AUDIO_PLL_QDPMC_OFFSET)
...
#define DISABLE                     0
#define ENABLE                      1
#define DEBUG_APINCLK_SEVERE        DISABLE
#define DEBUG_ACORECLK_SEVERE       DISABLE
#define DEBUG_APMCCLK_SEVERE        DISABLE
#define DEBUG_GEN_CLK               ENABLE
#define DEBUG_GEN_CLK_SEVERE        DISABLE
#define DEBUG_PERIPH_CLK_SEVERE     DISABLE
