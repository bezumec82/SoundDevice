...
//    int                     offset  = AT91_PMC_PCER;
    ...
    spin_lock_irqsave(gck->lock, flags);
        ...
        regmap_update_bits  (
                            gck->regmap,
                            AT91_PMC_PCR,
                            AT91_PMC_PCR_GCKCSS_MASK          | AT91_PMC_PCR_GCKDIV_MASK          | AT91_PMC_PCR_CMD | AT91_PMC_PCR_GCKEN | AT91_PMC_PCR_EN,
                            AT91_PMC_PCR_GCKCSS(gck->clk_src) | AT91_PMC_PCR_GCKDIV(gck->gck_div) | AT91_PMC_PCR_CMD | AT91_PMC_PCR_GCKEN | 0
                            );
#else
        regmap_update_bits  (
                            gck->regmap,
