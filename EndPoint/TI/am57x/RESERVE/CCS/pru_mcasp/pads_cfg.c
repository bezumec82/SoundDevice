...
static volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_SPI1_CS1_ptr     = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_SPI1_CS1_ADDR;
...
void config_mcasp8_pads(void)
{
    ...
    CTRL_CORE_PAD_MCASP2_AXR6_ptr   ->INPUTENABLE = 0x1;
...
{
    /* Switch multiplexor */
    CTRL_CORE_PAD_MCASP1_ACLKX_ADDR_ptr ->MUXMODE           = MCASP1_AXR14_MUXMODE_mcasp1_axr14;    //IDK572x -> AM57XX_PRU2ETH_MDCLK
    CTRL_CORE_PAD_MCASP1_FSX_ADDR_ptr   ->MUXMODE           = MCASP1_AXR8_MUXMODE_mcasp1_axr8  ;    //IDK572x -> AM57XX_PRU2ETH_MDDATA
    CTRL_CORE_PAD_MCASP1_AXR8_ptr       ->MUXMODE           = MCASP1_ACLKX_MUXMODE_mcasp1_aclkx;    //IDK572x -> AM57XX_PRU2ETH0_TXEN
    CTRL_CORE_PAD_MCASP1_AXR14_ptr      ->MUXMODE           = MCASP1_FSX_MUXMODE_mcasp1_fsx    ;    //IDK572x -> AM57XX_PRU2ETH0_RXDV
    /* 0 == Enable */
