...
#define BUF_SIZE_4ms_BYTES          BUF_SIZE_4ms_WORDS * (sizeof (int32_t))
#define BUF_QUANTUM             5

#define SEND_BUF_SIZE_WORDS     BUF_SIZE_4ms_WORDS * BUF_QUANTUM

#define SEND_BUF_SIZE_BYTES     BUF_SIZE_4ms_WORDS * (sizeof (int32_t)) * BUF_QUANTUM
