...
/* Status LED 0 */
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_VIN1A_D7_ptr     = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_VIN1A_D7_ADDR;      //IDK_572x -> AM57XX_STATUSLED0_GRN
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_VIN1A_D8_ptr     = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_VIN1A_D8_ADDR;      //IDK_572x -> AM57XX_STATUSLED0_YEL(blue)
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_VIN2A_VSYNC0_ptr = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_VIN2A_VSYNC0_ADDR;  //IDK_572x -> AM57XX_STATUSLED0_RED

/* Status LED 1 */
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_VIN1A_D6_ptr     = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_VIN1A_D6_ADDR;      //IDK_572x -> AM57XX_STATUSLED1_RED
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_UART1_RXD_ptr    = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_UART1_RXD_ADDR;     //IDK_572x -> AM57XX_STATUSLED1_YEL(blue)
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_UART1_TXD_ptr    = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_UART1_TXD_ADDR;     //IDK_572x -> AM57XX_STATUSLED1_GRN
...
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_VIN1A_D5_ptr     = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_VIN1A_D5_ADDR;      //IDK_572x -> AM57XX_INDETHER_LED0_GRN
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_XREF_CLK2_ptr    = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_XREF_CLK2_ADDR;     //IDK_572x -> AM57XX_INDETHER_LED0_RED
...
/* Industrial LED 2 */
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_SPI1_D1_ptr      = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_SPI1_D1_ADDR;       //IDK_572x -> AM57XX_INDETHER_LED2_GRN
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_SPI1_D0_ptr      = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_SPI1_D0_ADDR;       //IDK_572x -> AM57XX_INDETHER_LED2_RED
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_SPI1_CS0_ptr     = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_SPI1_CS0_ADDR;      //IDK_572x -> AM57XX_INDETHER_LED2_YEL(blue)

/* Industrial LED 3 */
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_VIN1A_D13_ptr    = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_VIN1A_D13_ADDR;     //IDK_572x -> AM57XX_INDETHER_LED3_GRN
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_VIN1A_D14_ptr    = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_VIN1A_D14_ADDR;     //IDK_572x -> AM57XX_INDETHER_LED3_YEL(blue)
volatile  struct CTRL_CORE_PAD * CTRL_CORE_PAD_SPI1_CS1_ptr     = (struct CTRL_CORE_PAD *)CTRL_CORE_PAD_SPI1_CS1_ADDR;      //IDK_572x -> AM57XX_INDETHER_LED3_RED
...
//        GPIO3_DATAOUT_ptr->GPIO_10  = 0x1;  //IDK_572x -> AM57XX_STATUSLED1_RED
        GPIO6_DATAOUT_ptr->GPIO_19  = 0x1;  //IDK_572x -> AM57XX_INDETHER_LED0_RED
        GPIO6_DATAOUT_ptr->GPIO_7   = 0x1;  //IDK_572x -> AM57XX_INDETHER_LED1_RED
...
//        GPIO7_DATAOUT_ptr->GPIO_22  = 0x1;  //IDK_572x -> AM57XX_STATUSLED1_YEL(blue)
        GPIO1_DATAOUT_ptr->GPIO_4   = 0x1;  //IDK_572x -> AM57XX_INDETHER_LED0_YEL(blue)
        GPIO1_DATAOUT_ptr->GPIO_5   = 0x1;  //IDK_572x -> AM57XX_INDETHER_LED1_YEL(blue)
...
//        GPIO7_DATAOUT_ptr->GPIO_23  = 0x1;  //IDK_572x -> AM57XX_STATUSLED1_GRN
        GPIO3_DATAOUT_ptr->GPIO_9   = 0x1;  //IDK_572x -> AM57XX_INDETHER_LED0_GRN
        GPIO2_DATAOUT_ptr->GPIO_29  = 0x1;  //IDK_572x -> AM57XX_INDETHER_LED1_GRN
...
//        GPIO7_DATAOUT_ptr->GPIO_23  = 0x0;  //IDK_572x -> AM57XX_STATUSLED1_GRN
        ...
        __delay_cycles(100000000);
#else
         GPIO1_DATAOUT_ptr->GPIO_4  = 0x1;
         GPIO6_DATAOUT_ptr->GPIO_7  = 0x1;
         GPIO2_DATAOUT_ptr->GPIO_29 = 0x1;
         GPIO1_DATAOUT_ptr->GPIO_5  = 0x1;
        __delay_cycles(200000000);
        /* McASP8 pins */
        GPIO1_DATAOUT_ptr->GPIO_4   = 0x0;  //IDK_572x -> AM57XX_INDETHER_LED0_YEL(blue)    mcasp8_axr0
        GPIO6_DATAOUT_ptr->GPIO_7   = 0x0;  //IDK_572x -> AM57XX_INDETHER_LED1_RED          mcasp8_axr1
