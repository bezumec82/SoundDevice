...
#define IDK_AM5728              TRUE

#define SETUP_DPLL_ABE          TRUE

#define DEBUG_LEDS_IDK_AM5728   FALSE
 ...
 */
#define DDR_START_ADDR          (uint32_t)( 0x80000000 + 0x40000000 - 0x01000000 )
...
#define ECHO_TEST_TX1_to_RX8            FALSE
...
/* To conduct echo test connect mcasp8_axr0 to mcasp1_axr14*/
    ...
    #error "Can't conduct ECHO TEST. MCASP8_TX -> {MCASP1_RX -> MCASP1_TX}"
#endif

#if ( ECHO_TEST_TX1_to_RX8 && ( (!MCASP8_TX) || (!MCASP8_RX) || (!MCASP1_TX) ))
    #error "Can't conduct ECHO TEST. MCASP1_TX -> {MCASP8_RX -> MCASP8_TX}"
#endif
