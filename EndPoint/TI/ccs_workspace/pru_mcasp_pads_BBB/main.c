...
#define CONF_GPMC_A8_OFF                        0x860   //USR3  V16    GPMC_A8  GPIO1_24
                                                                                                             //MCASP PIN     MODE    PIN NAME        GPIO
volatile uint32_t * CONF_LCD_DATA8_PTR     = (uint32_t *)( CONTROL_MODULE_ADDR + CONF_LCD_DATA8_OFF );       //MCASP0_ACLKX  MODE3   LCD_DATA8       gpio2_14
volatile uint32_t * CONF_LCD_DATA9_PTR     = (uint32_t *)( CONTROL_MODULE_ADDR + CONF_LCD_DATA9_OFF );       //MCASP0_FSX    MODE3   LCD_DATA9       gpio2_15
volatile uint32_t * CONF_LCD_DATA10_PTR    = (uint32_t *)( CONTROL_MODULE_ADDR + CONF_LCD_DATA10_OFF );      //MCASP0_AXR0   MODE3   LCD_DATA10      gpio2_16
volatile uint32_t * CONF_LCD_DATA14_PTR    = (uint32_t *)( CONTROL_MODULE_ADDR + CONF_LCD_DATA14_OFF );      //MCASP0_AXR1   MODE3   LCD_DATA14      gpio0_10
                                                                                                             //MCASP PIN     MODE    PIN NAME        GPIO
volatile uint32_t * CONF_MCASP0_ACLKR_PTR  = (uint32_t *)( CONTROL_MODULE_ADDR + CONF_MCASP0_ACLKR_OFF );    //MCASP1_ACLKX  MODE3   MCASP0_ACLKR    gpio3_18
volatile uint32_t * CONF_MCASP0_FSR_PTR    = (uint32_t *)( CONTROL_MODULE_ADDR + CONF_MCASP0_FSR_OFF );      //MCASP1_FSX    MODE3   MCASP0_FSR      gpio3_21
volatile uint32_t * CONF_MCASP0_AXR1_PTR   = (uint32_t *)( CONTROL_MODULE_ADDR + CONF_MCASP0_AXR1_OFF );     //MCASP1_AXR0   MODE3   MCASP0_AXR      gpio3_19
volatile uint32_t * CONF_MCASP0_AHCLKX_PTR = (uint32_t *)( CONTROL_MODULE_ADDR + CONF_MCASP0_AHCLKX_OFF );   //MCASP1_AXR1   MODE3   MCASP0_AHCLKX   gpio3_20
                                                                                                             //BBB   Pad    Pad name
volatile uint32_t * CONF_GPMC_A5_PTR       = (uint32_t *)( CONTROL_MODULE_ADDR + CONF_GPMC_A5_OFF );         //USR0  V15    GPMC_A5  GPIO1_21
volatile uint32_t * CONF_GPMC_A6_PTR       = (uint32_t *)( CONTROL_MODULE_ADDR + CONF_GPMC_A6_OFF );         //USR1  U15    GPMC_A6  GPIO1_22
volatile uint32_t * CONF_GPMC_A7_PTR       = (uint32_t *)( CONTROL_MODULE_ADDR + CONF_GPMC_A7_OFF );         //USR2  T15    GPMC_A7  GPIO1_23
volatile uint32_t * CONF_GPMC_A8_PTR       = (uint32_t *)( CONTROL_MODULE_ADDR + CONF_GPMC_A8_OFF );         //USR3  V16    GPMC_A8  GPIO1_24
                                                                                                                                     //MCASP PIN     MODE    PIN NAME        GPIO
volatile struct CONF_MODULE_PIN * CONF_LCD_DATA8     = (struct CONF_MODULE_PIN *)( CONTROL_MODULE_ADDR + CONF_LCD_DATA8_OFF );       //MCASP0_ACLKX  MODE3   LCD_DATA8       gpio2_14
volatile struct CONF_MODULE_PIN * CONF_LCD_DATA9     = (struct CONF_MODULE_PIN *)( CONTROL_MODULE_ADDR + CONF_LCD_DATA9_OFF );       //MCASP0_FSX    MODE3   LCD_DATA9       gpio2_15
volatile struct CONF_MODULE_PIN * CONF_LCD_DATA10    = (struct CONF_MODULE_PIN *)( CONTROL_MODULE_ADDR + CONF_LCD_DATA10_OFF );      //MCASP0_AXR0   MODE3   LCD_DATA10      gpio2_16
volatile struct CONF_MODULE_PIN * CONF_LCD_DATA14    = (struct CONF_MODULE_PIN *)( CONTROL_MODULE_ADDR + CONF_LCD_DATA14_OFF );      //MCASP0_AXR1   MODE3   LCD_DATA14      gpio0_10
                                                                                                                                     //MCASP PIN     MODE    PIN NAME        GPIO
volatile struct CONF_MODULE_PIN * CONF_MCASP0_ACLKR  = (struct CONF_MODULE_PIN *)( CONTROL_MODULE_ADDR + CONF_MCASP0_ACLKR_OFF );    //MCASP1_ACLKX  MODE3   MCASP0_ACLKR    gpio3_18
volatile struct CONF_MODULE_PIN * CONF_MCASP0_FSR    = (struct CONF_MODULE_PIN *)( CONTROL_MODULE_ADDR + CONF_MCASP0_FSR_OFF );      //MCASP1_FSX    MODE3   MCASP0_FSR      gpio3_21
volatile struct CONF_MODULE_PIN * CONF_MCASP0_AXR1   = (struct CONF_MODULE_PIN *)( CONTROL_MODULE_ADDR + CONF_MCASP0_AXR1_OFF );     //MCASP1_AXR0   MODE3   MCASP0_AXR      gpio3_19
volatile struct CONF_MODULE_PIN * CONF_MCASP0_AHCLKX = (struct CONF_MODULE_PIN *)( CONTROL_MODULE_ADDR + CONF_MCASP0_AHCLKX_OFF );   //MCASP1_AXR1   MODE3   MCASP0_AHCLKX   gpio3_20
                                                                                                                                     //BBB   Pad    Pad name
...
#if (0)
    * CONF_LCD_DATA8_PTR     = CONF_MODULE_PIN_MODE_VAL(MODE7) | CONF_MODULE_PIN_MODE_PUDEN_VAL(PULL_EN) | CONF_MODULE_PIN_MODE_PUTYPESEL_VAL(PULLUP_SEL);     //MCASP0_ACLKX  MODE3
    * CONF_LCD_DATA9_PTR     = CONF_MODULE_PIN_MODE_VAL(MODE7) | CONF_MODULE_PIN_MODE_PUDEN_VAL(PULL_EN) | CONF_MODULE_PIN_MODE_PUTYPESEL_VAL(PULLUP_SEL);     //MCASP0_FSX    MODE3 OUT
    * CONF_LCD_DATA10_PTR    = CONF_MODULE_PIN_MODE_VAL(MODE7) | CONF_MODULE_PIN_MODE_PUDEN_VAL(PULL_EN) | CONF_MODULE_PIN_MODE_PUTYPESEL_VAL(PULLUP_SEL);     //MCASP0_AXR0   MODE3 TX
    * CONF_LCD_DATA14_PTR    = CONF_MODULE_PIN_MODE_VAL(MODE7) | CONF_MODULE_PIN_MODE_PUDEN_VAL(PULL_EN) | CONF_MODULE_PIN_MODE_PUTYPESEL_VAL(PULLUP_SEL);     //MCASP0_AXR1   MODE3 RX
    * CONF_MCASP0_ACLKR_PTR  = CONF_MODULE_PIN_MODE_VAL(MODE7) | CONF_MODULE_PIN_MODE_PUDEN_VAL(PULL_EN) | CONF_MODULE_PIN_MODE_PUTYPESEL_VAL(PULLUP_SEL);     //MCASP1_ACLKX  MODE3
    * CONF_MCASP0_FSR_PTR    = CONF_MODULE_PIN_MODE_VAL(MODE7) | CONF_MODULE_PIN_MODE_PUDEN_VAL(PULL_EN) | CONF_MODULE_PIN_MODE_PUTYPESEL_VAL(PULLUP_SEL);     //MCASP1_FSX    MODE3
    * CONF_MCASP0_AXR1_PTR   = CONF_MODULE_PIN_MODE_VAL(MODE7) | CONF_MODULE_PIN_MODE_PUDEN_VAL(PULL_EN) | CONF_MODULE_PIN_MODE_PUTYPESEL_VAL(PULLUP_SEL);     //MCASP1_AXR0   MODE3 TX
    * CONF_MCASP0_AHCLKX_PTR = CONF_MODULE_PIN_MODE_VAL(MODE7) | CONF_MODULE_PIN_MODE_PUDEN_VAL(PULL_EN) | CONF_MODULE_PIN_MODE_PUTYPESEL_VAL(PULLUP_SEL);     //MCASP1_AXR1   MODE3 RX
    * CONF_GPMC_A5_PTR       = CONF_MODULE_PIN_MODE_VAL(MODE7) | CONF_MODULE_PIN_MODE_PUDEN_VAL(PULL_EN) | CONF_MODULE_PIN_MODE_PUTYPESEL_VAL(PULLUP_SEL);     //USR0  V15  GPMC_A5  GPIO1_21
    * CONF_GPMC_A6_PTR       = CONF_MODULE_PIN_MODE_VAL(MODE7) | CONF_MODULE_PIN_MODE_PUDEN_VAL(PULL_EN) | CONF_MODULE_PIN_MODE_PUTYPESEL_VAL(PULLUP_SEL);     //USR1  U15  GPMC_A6  GPIO1_22
    * CONF_GPMC_A7_PTR       = CONF_MODULE_PIN_MODE_VAL(MODE7) | CONF_MODULE_PIN_MODE_PUDEN_VAL(PULL_EN) | CONF_MODULE_PIN_MODE_PUTYPESEL_VAL(PULLUP_SEL);     //USR2  T15  GPMC_A7  GPIO1_23
    * CONF_GPMC_A8_PTR       = CONF_MODULE_PIN_MODE_VAL(MODE7) | CONF_MODULE_PIN_MODE_PUDEN_VAL(PULL_EN) | CONF_MODULE_PIN_MODE_PUTYPESEL_VAL(PULLUP_SEL);     //USR3  V16  GPMC_A8  GPIO1_24
#else                                           //MCASP PIN     MODE    PIN NAME        GPIO
    CONF_LCD_DATA8     ->MODE = MODE0;          //MCASP0_ACLKX  MODE3   LCD_DATA8       gpio2_14
    CONF_LCD_DATA9     ->MODE = MODE0;          //MCASP0_FSX    MODE3   LCD_DATA9       gpio2_15
    CONF_LCD_DATA10    ->MODE = MODE0;          //MCASP0_AXR0   MODE3   LCD_DATA10      gpio2_16
    CONF_LCD_DATA14    ->MODE = MODE0;          //MCASP0_AXR1   MODE3   LCD_DATA14      gpio0_10
    CONF_MCASP0_ACLKR  ->MODE = MODE0;          //MCASP1_ACLKX  MODE3   MCASP0_ACLKR    gpio3_18
    CONF_MCASP0_FSR    ->MODE = MODE0;          //MCASP1_FSX    MODE3   MCASP0_FSR      gpio3_21
    CONF_MCASP0_AXR1   ->MODE = MODE0;          //MCASP1_AXR0   MODE3   MCASP0_AXR      gpio3_19
    CONF_MCASP0_AHCLKX ->MODE = MODE0;          //MCASP1_AXR1   MODE3   MCASP0_AHCLKX   gpio3_20
    CONF_GPMC_A5       ->MODE = MODE0;          //USR0  V15  GPMC_A5  GPIO1_21
    CONF_GPMC_A6       ->MODE = MODE0;          //USR1  U15  GPMC_A6  GPIO1_22
    CONF_GPMC_A7       ->MODE = MODE0;          //USR2  T15  GPMC_A7  GPIO1_23
    CONF_GPMC_A8       ->MODE = MODE0;          //USR3  V16  GPMC_A8  GPIO1_24
/* -------------------------------------------------------------------------- */
